        ...
        <div className="flex items-center md:justify-normal flex-col gap-10">
          ...
          <div className="flex gap-5">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <p className="w-40 text-sm">236 5th SE Avenue, New York NY10000, United States</p>
            </div>
          </div>
          ...
          <div className="flex gap-5">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <p className="w-40 text-sm">Mobile: +(84) 546-6789 Hotline: +(84) 456-6789</p>
            </div>
          </div>
          ...
          <i className="fas fa-clock mt-1.5"></i>
            <div className="flex flex-col gap-1.5">
              ...
              <p className="w-40 text-sm">Monday-Friday: 9:00 - 22:00 <br /> Saturday-Sunday: 9:00 - 21:00</p>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-3">
              ...
              <input className="w-96 h-16 border border-zinc-400 rounded-md px-4 focus:outline-none" value={name} onChange={(e) => setName(e.target.value)} type="text" placeholder="abc" />
              {errors?.name && (
            ...
            <div className="flex flex-col gap-3">
              ...
              <input className="w-96 h-16 border border-zinc-400 rounded-md px-4 focus:outline-none" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="person123@hotmail.com" />
              {errors?.email && (
            ...
            <div className="flex flex-col gap-3">
              ...
              <input className="w-96 h-16 border border-zinc-400 rounded-md px-4 focus:outline-none" type="text" placeholder="this is a optional" />
            </div>

            <div className="flex flex-col gap-3">
              <label htmlFor="">Message</label>
              <input type="text" className="w-96 h-20 border border-zinc-400 rounded-md px-4 focus:outline-none" placeholder="Your Message"></input>
            </div>

            <button className="bg-yellow-600 w-48 py-2.5 text-white rounded-md">Submit</button>
          </form> 
